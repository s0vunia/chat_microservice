...
func (x *chatV1ConnectChatClient) Recv() (*MessageCreate, error) {
	m := new(MessageCreate)
...
func (x *chatV1ConnectChatServer) Send(m *MessageCreate) error {
